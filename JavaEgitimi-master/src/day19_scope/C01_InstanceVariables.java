...
public class C01_InstanceVariables {
    /*
        class icerisinde her yerden kullanmak istediginiz variable'lari class level'da(Class'in icinde ama method'larin disinda)
    ...
    public static void main(String[] args) {
       ...
       /*
        ...
        instance variables static olmadigi icin static klube uye main method'dan direkt kullanamayiz.
        instance variable'larin diger adi object variable'dir. Dolayisiyla obje olusturursaniz instance variable'lari
        her yerden kullanabilirsiniz.
        */
    ...
    public static void  staticMethod() {
        ...
        /*
        bir method'un icerisinde olusturulan variable, sadece o method'un icinden kullanilabilir.(Local variable)
         */
        /*
        instSayi=30;
        instance variable'lara main method disindaki static method'lardan da direkt ulasamayiz.
        obje olusturursak ulasabiliriz.
         */
        C01_InstanceVariables obje4 = new C01_InstanceVariables();
        System.out.println("obje3 degismeden once : " +obje4.instSayi);
    }
