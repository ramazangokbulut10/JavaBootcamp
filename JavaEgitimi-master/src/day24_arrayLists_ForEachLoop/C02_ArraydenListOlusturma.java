...
public class  C02_ArraydenListOlusturma {
    public static void main(String[] args) {
        ...
        Random rnd = new Random(); //0 ile 1 arasında sayı üretir

        int sayi =0;
        List<Integer> sayiListesi = new ArrayList<>();


        while (sayiListesi.size()<200){   //200 oluncaya kadar sayı üretip listeye eklesin diye yaptık
            sayi = rnd.nextInt(1000);         //girdigim tamsayıya kadar üretir
        ...
        while (!bildiMi){
            ...
            if (sayiListesi.contains(sayi)){
                ...
                bildiMi=true;
            }else System.out.println(tahminSayisi + " adet sayi soylediniz ama hic biri listede yok");
            tahminSayisi++;
        }
