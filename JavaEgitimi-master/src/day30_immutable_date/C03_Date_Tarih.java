...
public class C03_Date_Tarih {
    public static void main(String[] args) {
        ...
        System.out.println(tarih.isLeapYear()); //artık yıl olup olmadıgını verir
                                               // true veya false verir

        LocalDate tarih2 =LocalDate.of(2001,5,15);
        System.out.println(tarih2); //2001-05-15

        LocalDate tarih3 =LocalDate.of(1993, Month.MARCH,16);
        System.out.println(tarih3); //1993-03-16
        ...
        System.out.println(tarih.isAfter(tarih2)); //diğer tarihten sonra mı //true
        ...
        if (tarih2.isAfter(tarih3)){
            ...
            System.out.println("iki tarih birbiriyle aynı");//1993-03-16tarihinde dogan daha buyuk
        }
